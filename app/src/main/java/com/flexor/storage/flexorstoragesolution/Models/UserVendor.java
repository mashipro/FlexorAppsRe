...
public class UserVendor implements Parcelable {
    ...
    private Integer vendorBoxPrice;
    ...
    public Integer getVendorBoxPrice() {
        return vendorBoxPrice;
    }

    public void setVendorBoxPrice(Integer vendorBoxPrice) {
